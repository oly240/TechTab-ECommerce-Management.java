...
Instalare și Rulare
Rulează scriptul proiect_bd.sql în SQL Server Management Studio (SSMS) pentru a genera structura și datele de test.

Clonează repository-ul și deschide-l în IntelliJ IDEA.

Configurează datele de conectare la baza de date în application.properties.

Rulează aplicația și accesează http://localhost:8080/admin.
